...
: 'download' in HTMLAnchorElement.prototype ? function saveAs(blob, name, opts) {
  ...
  if (typeof blob === 'string') {
    ...
    if (a.origin !== location.origin) {
      ...
      /*
              ...
              myReader.onload = function(event){
                ...
                // console.log('myReader.result', toBuffer(myReader.result));
                // console.log('myReader.result', myReader.result.toString());
              };
    ...
    // Support blobs
    a.href = URL.createObjectURL(blob); // console.log('URL', URL);
    // console.log('a', a);

    var myReader = new FileReader();

    myReader.onload = function (event) {// console.log('myReader.result', myReader.result);
      // console.log(JSON.stringify(myReader.result));
      // console.log('myReader.result', toBuffer(myReader.result));
      // console.log('myReader.result', myReader.result.toString());
    };
